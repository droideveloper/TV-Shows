...
data class TVShowDetailModel(override val state: SyncState, override val data: TVShowDetailEntity, val saveState: Boolean = false): Model<TVShowDetailEntity>(state, data)